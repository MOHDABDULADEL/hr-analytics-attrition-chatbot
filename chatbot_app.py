...
# ------------------ PAGE CONFIG ------------------
st.set_page_config(
    page_title="HR Analytics – Power BI Style",
    layout="wide"
)
...
st.markdown(f"""
<div class="header">
    <h2>HR Analytics Dashboard – Power BI Style</h2>
    <small>Attrition • Engagement • Chatbot • Predictions</small>
</div>
""", unsafe_allow_html=True)
...
with main:
    ...
    with ch2:
        ...
        chart2 = (
            ...
            .encode(theta="Count", color="Level", tooltip=["Level","Count"])
        )
    ...
    with c2:
        ...
        income = st.slider("Monthly Income", 1000, 25000, 5000)
        tw = st.slider("Total Working Years", 0, 40, 5)
        yc = st.slider("Years at Company", 0, 40, 3)
    ...
    with c3:
        ...
        emp_id = st.selectbox("Employee ID", df["EmployeeNumber"].tolist())

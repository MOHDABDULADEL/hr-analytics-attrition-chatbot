...
st.title("HR Analytics – Employee Engagement & Attrition Dashboard")
...
with col3:
    st.metric("Average Engagement Score", round(avg_engagement, 2))
...
st.write("Enter employee characteristics to predict attrition risk.")
